<cfcomponent>
    ...
    <cffunction name="GetExporterCounts" access="remote" returnType="struct" returnFormat="json" output="true">
        ...
        <cfscript>
			...
			if(isDefined('str.topExportersArr'))
			{
	...
	<cffunction access="private" name="GetDataForTable" output="yes" returntype="query">
        ...
        <cfargument name="isUS" type="numeric" required="no" default="1">   
        ...
        <cfscript>
			...
			for(i=1;i lte qGetDataForTable.recordCount;i=i+1){
				...
				ArrayAppend(prodArr, trim(ReplaceNoCase(qGetDataForTable.EXPORTER_NAICS_LVL2_DESC[i],'Unknown Group','Group')));
			}
			...
			QueryAddColumn(qGetDataForTable,'EXPORTER_NAICS_LVL2_DESC_ALT','VarChar',prodArr);			
		</cfscript>    
    ...
    <cffunction name="GetUSDataTable" access="remote" output="true" returntype="any" returnformat="json">
		...
		<cfoutput query="qS">
            ...
            <cfquery name="_qFLAG_TE" dbtype="query">
    ...
    <cffunction name="GetStateDataTable" access="remote" output="true" returntype="any" returnformat="json">
        ...
        <cfscript>
			strData = StructNew();
			qry = GetDataForTable(yStart,yEnd,ABBREVIATION_TXT,CNGRSNL_DSTRCT,FLAG_SB,FLAG_MO,FLAG_WO,FLAG_ENV,FLAG_RE,FLAG_OT,0);
